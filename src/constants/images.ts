...
export const SUBCATEGORY_IMAGES: Record<string, string> = {
  ...
  'fotografie': `${BASE}/artist_fotografie.jpg`,
  'cursuri ilustratie': `${BASE}/artist_desenat.jpg`,
  'benzi desenate': `${BASE}/artist_desenat.jpg`,
  ...
  'game development': `${BASE}/tehnic_robotica4.jpg`,
  'editare video': `${BASE}/tehnic_programare1.jpg`,
  'animatie': `${BASE}/tehnic_programare2.jpg`,
  'content creator': `${BASE}/tehnic_programare1.jpg`,
  'modelare 3d': `${BASE}/tehnic_lego.jpg`,
